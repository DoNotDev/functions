...
Backend functions for DoNotDev Framework - Firebase, Vercel, and platform-agnostic implementations for auth, billing, CRUD, and OAuth
...
```bash
bun add @donotdev/functions
# or
npm install @donotdev/functions
```
...
- [Report a bug](https://github.com/donotdev/functions/issues/new?template=bug_report.md)
- [Request a feature](https://github.com/donotdev/functions/issues/new?template=feature_request.md)
